...
def test_aikuisen_rasvaprosentti():
    ...
    assert fitness.aikuisten_rasvaprosentti(13.8, 40, 1) == 9.6
    assert fitness.aikuisten_rasvaprosentti(34.6, 70, 1) == 41.4

    # Testejä aikuisia naisia
    assert fitness.aikuisten_rasvaprosentti(20.8, 20, 0) == 24.2
    assert fitness.aikuisten_rasvaprosentti(13.8, 40, 0) == 20.4
    assert fitness.aikuisten_rasvaprosentti(34.6, 60, 0) == 49.9
